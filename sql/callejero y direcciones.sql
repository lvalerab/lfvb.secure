...
CREATE TABLE dirn_direccion_normalizada (ID_DIRE VARCHAR(36) PRIMARY KEY,  ID_CALLE VARCHAR(36), NUMERO_DIRN VARCHAR(10), PUERTA_DIRN VARCHAR(10), PISO_DIRN VARCHAR(10), BLOQ_DIRN VARCHAR(10), EDIF_DIRN VARCHAR(60), AMPLIACION_DIRN VARCHAR(60));
